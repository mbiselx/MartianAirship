...
subplot(3,1,3)
    ...
    grid on
    axis tight
saveas(fig1, [save_path , 'hz_dynamics.png'])
...
subplot(3,1,3)
    ...
    grid on
    axis tight
saveas(fig2, [save_path , 'vt_dynamics.png'])
...
subplot(3,1,3)
    ...
    grid on
    axis tight
saveas(fig3, [save_path , 'ang_dynamics.png'])
...
%% extract frequency of the response 
...
legend("\theta")
title("Frequencies of the response")
grid on 
